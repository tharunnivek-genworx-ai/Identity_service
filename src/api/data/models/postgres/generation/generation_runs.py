# C:\CapStone\Identity_service\src\api\data\models\postgres\generation\generation_runs.py
import uuid
...
class GenerationRun(Base):
    ...
    # study_material | quiz | hint
    pipeline = Column(String(30), nullable=False)
    # node | quiz — scopes advisory locks and resumable-run lookups
    ...
    # running | failed | completed | superseded
