...
class NodeRepository:
    ...
    async def get_nodes_by_ids(
        ...
        """Fetch multiple nodes by ID within a given space. Used for reorder validation."""
        result = await self.db.execute(
    ...
    async def get_next_order_index(
        self, space_id: UUID, parent_id: UUID | None
    ) -> int:
